 ...
 * @ORM\Entity(repositoryClass="LPC\BackendBundle\Repository\RecursoRepository")
...
class Recurso
{
   ...
   /**
     ...
     *
     * @ORM\ManyToMany(targetEntity="LPC\BackendBundle\Entity\Edificio")
     ...
     * Add edificios
     *
     * @param \LPC\BackendBundle\Entity\Edificio $edificios
     * @return Recurso
     */
    public function addEdificio(\LPC\BackendBundle\Entity\Edificio $edificios)
    {
     ...
     * @param \LPC\BackendBundle\Entity\Edificio $edificios
     */
    public function removeEdificio(\LPC\BackendBundle\Entity\Edificio $edificios)
    {
