 ...
 * @ORM\Entity(repositoryClass="LPC\BackendBundle\Repository\ConfiguracionesRepository")
...
class Configuraciones
{
    ...
    */
    ...
    {
        $this->slug = \LPC\BackendBundle\Utils\Richsys::slugify($this->getConfiguracion());
    }
    ...
    */
    public function preSaveLinkVideo()
    {
      if ($this->getTipoConfiguracion()==self::$LINK_VIDEO) {
        $infoVideo=  \LPC\BackendBundle\Utils\Richsys::getTitleAndImageVideoYoutube($this->getTexto());
