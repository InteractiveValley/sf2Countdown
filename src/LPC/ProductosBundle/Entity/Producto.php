...
namespace LPC\ProductosBundle\Entity;
 ...
 * @ORM\Entity(repositoryClass="LPC\ProductosBundle\Repository\ProductoRepository")
 */
class Producto
{
    /**
     ...
     * @var string
     *
     * @ORM\Column(name="unidadMedida", type="string", length=4)
     */
